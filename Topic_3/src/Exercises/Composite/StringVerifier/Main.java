...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // -------------
        // Exercise: Create all the classes that show up bellow. You should use the Composite Pattern whenever possible.
        // Some useful classes are already available for you to extend from.
        // Hint: Start with the simpler classes, such as LengthIsEven, LengthIsOdd
        //
        // When you're done, you may uncomment the commented out classes and prints
        // -------------
